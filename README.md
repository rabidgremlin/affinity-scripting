...
## Findings
- The MCP server has access to a bunch of documentation that an AI agent can use as reference for creating scripts etc. The `extract_docs.js` script below can extract all these docs and same them locally so you can take a look at them. This includes some example scripts.
